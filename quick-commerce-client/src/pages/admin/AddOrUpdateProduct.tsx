...
import { addProduct, getProductById, updateProductById } from "../../http/product";
...
const productSchema = z.object({
    ...
    // stock: z.coerce.number().int().default(0), // Default value
});
    ...
    const onSubmit = async (data: ProductFormData) => {
        ...
        try {
            if (productId) {
                ...
                const response = await updateProductById(parseInt(productId), data);
